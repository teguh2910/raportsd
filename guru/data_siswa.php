              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM data_siswa JOIN
                    data_guru ON data_siswa.kelas=data_guru.kelas
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="siswa/hapus_data_siswa.php?id_siswa=<?php echo $row['id_siswa']; ?>" class="btn btn-xs btn-danger">Delete</a>                        
                    </td>
                  </tr>
                  <?php
