  ...
  if (isset($_GET['id_nilai'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='data_nilai.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='data_nilai.php';</script>";
  }         
  ?>
              ...
              <form method="POST" action="nilai/proses_edit_data_nilai.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    // query to retrieve the list of teachers, with an additional column to indicate if the teacher is selected or not
                    $query = "SELECT *, IF(id_pelajaran = $id_pelajaran_edit, 1, 0) AS is_selected FROM mata_pelajaran GROUP BY nama_mata_pelajaran";
