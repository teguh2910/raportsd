              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-sm btn-primary" href="data_presensi.php?id_siswa=<?php echo $row['id_siswa']; ?>">Presensi</a></td>
                    <td><a class="btn btn-sm btn-primary" href="data_kasus.php?id_siswa=<?php echo $row['id_siswa']; ?>">Kasus</a></td>                    
                  </tr>
                  <?php
