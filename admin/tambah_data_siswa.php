              ...
              <form method="POST" action="siswa/proses_tambah_data_siswa.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label>NIS</label>
                    <input type="text" id="nis" pattern="[0-9]+" name="nis" minlength="9" required
                      oninvalid="this.setCustomValidity('NIP/NISN hanya bisa diisi dengan angka')"
                      oninput="this.setCustomValidity('')" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>NISN</label>
                    <input type="text" id="nisn" pattern="[0-9]+" name="nisn" minlength="10" required
                      oninvalid="this.setCustomValidity('NIP/NISN hanya bisa diisi dengan angka')"
                      oninput="this.setCustomValidity('')" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Jenis Kelamin</label>
                    <br> <input value="l" name="jk" type="radio"> Laki-Laki 
                    <input value="p" name="jk" type="radio"> Perempuan                    
                  </div>
                  <div class="form-group">
                    <label>Nama Siswa</label>
                    <input type="text" pattern="[A-Za-z., ]+" id="nama" name="nama_siswa" required
