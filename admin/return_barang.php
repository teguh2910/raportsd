        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Return Barang</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-info">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form method="POST" action="proses_return.php" enctype="multipart/form-data">
                <div class="card-body">
                  <!-- select -->
                  ...
                  <div class="form-group">
                    <label>Jumlah Return Barang</label>
                    <input type="number" name="jumlah_return" class="form-control" placeholder="Jumlah Barang">
                  </div>
                </div>
                <!-- /.card-body -->
