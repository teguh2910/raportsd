          ...
          <div class="card card-info">
              ...
              <form method="POST" action="guru/proses_edit_data_guru.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>NIP</label>
                    <input type="text" id="nip" pattern="[0-9]+" name="nip" value="<?php echo $data['id_guru']; ?>" minlength="18" required oninvalid="this.setCustomValidity('NIP/NISN hanya bisa diisi dengan angka')" oninput="this.setCustomValidity('')" class="form-control">
                  </div>  
                <div class="form-group">
                    <label>Nama Guru</label>
                    <input type="text" pattern="[A-Za-z.,]+" id="nama_guru" value="<?php echo $data['nama_guru']; ?>" name="nama_guru" required oninvalid="this.setCustomValidity('nama harus diisi dengan huruf')" oninput="this.setCustomValidity('')" class="form-control" />
                  </div>
					<div class="form-group">
                    <label>Kelas</label>
